...
```typescript
// bin/app.ts - 应用到所有资源
const requiredTags = { Project: '{{PROJECT_SLUG}}', Environment: envName, CostCenter: 'TODO: 填写成本中心', ManagedBy: 'cdk' };
...
new budgets.CfnBudget(this, 'Budget', {
  ...
  notificationsWithSubscribers: [{
    ...
    subscribers: [{ address: 'TODO: 填写告警邮箱', subscriptionType: 'EMAIL' }],
  }],
});
```
