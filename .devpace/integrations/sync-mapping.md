...
- **类型**：github
- **连接**：arch-team/claude-context-templates
- **同步模式**：push
- **冲突策略**：ask-user
...
| PF（产品功能） | Epic / 大 Issue | 产品功能对应 GitHub Issue（可用 Epic 标签标识） |
...
| 结果 | 外部动作 | 说明 |
|------|---------|------|
| 通过 | Comment + gate-2-passed 标签 | 在关联 Issue 添加通过评论和标签 |
...
| 结果 | 外部动作 | 说明 |
|------|---------|------|
| 待处理 | Comment（review 摘要） | 在关联 Issue 添加 review 摘要评论 |
